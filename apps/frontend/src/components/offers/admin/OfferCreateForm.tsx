...
export function OfferCreateForm({ onSuccess, onCancel }: OfferCreateFormProps) {
  ...
  const [projectVariants, setProjectVariants] = useState<any[]>([]);
  ...
  const loadProjectDetails = async (projectId: string) => {
    try {
      ...
      // Load project phases and variants
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{project.client?.firstName} {project.client?.lastName}</p>
                    </div>
                  </div>
                </div>
              ))}
